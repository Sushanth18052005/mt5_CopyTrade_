...
export default function SecurityLayer({ children }: SecurityLayerProps) {
  ...
  // Allow local backend during development (localhost:8000) and Atlas production host
  cspMeta.setAttribute('content', "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; connect-src 'self' https://mt5-copytrade.onrender.com http://localhost:8000 http://127.0.0.1:8000 ws://localhost:8000");
