...
export default function AdminPanel({ onLogout }: AdminPanelProps) {
  ...
  const approveUser = async (userId: string, userEmail: string) => {
    try {
      ...
      const response = await fetch('https://mt5-copytrade.onrender.com/api/v1/admin-simple/activate-user', {
        method: 'POST',
        headers: {
  ...
  const updateUserRole = async (userId: string, userEmail: string, newRole: string) => {
    try {
      ...
      const response = await fetch('https://mt5-copytrade.onrender.com/api/v1/admin-simple/update-user-role', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const suspendUser = async (userId: string, userEmail: string) => {
    try {
      ...
      const response = await fetch('https://mt5-copytrade.onrender.com/api/v1/admin-simple/suspend-user', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const reactivateUser = async (userId: string, userEmail: string) => {
    try {
      ...
      const response = await fetch('https://mt5-copytrade.onrender.com/api/v1/admin-simple/reactivate-user', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const addNewUser = async () => {
    try {
      ...
      const response = await fetch('https://mt5-copytrade.onrender.com/api/v1/admin-simple/create-user', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
